...
%>				
				<ul class="nav flex-column">
		          ...
		          <li class="nav-item title"><a class="nav-link active" href="../admin/bord_list.jsp">커뮤니티 관리</a></li>
		        </ul>
...
<ul class="nav flex-column">
    ...
    <li class="nav-item title">
      ...
      <ul class="nav flex-column">      
	    <li class="nav-item sub">
	        <a class="nav-link active" href="../reservation/res_intro_main.jsp">실시간예약</a>
	    </li>
	    <li class="nav-item sub">
    ...
    <li class="nav-item title">
        <a class="nav-link" href="../main/information.jsp">공지사항</a>
    </li>
    <li class="nav-item title">
