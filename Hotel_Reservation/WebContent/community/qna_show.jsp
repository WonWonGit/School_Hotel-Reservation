...
<body>
  ...
  <path fill-rule="evenodd"
				...
				<tr height="30" align="center">
					<td width="100">글제목</td>
					<td width="200" colspan="3"><%=title%></td>
				</tr>
				<tr height="30" align="center">
					<td width="100">글내용</td>
					<td width="200" colspan="3"><textarea rows="10" cols="60"
				...
				<tr height="30" align="center">
					...
					<td width="200" colspan="3">
						<%
							if (comment != null) {
						%><textarea rows="10" cols="60" readonly><%=comment%></textarea>
						<%
							} else {
 ...
 %> <a href="#"
						...
						aria-pressed="true" onclick="cmt_ok()">답변하기</a>
						<%
							}
