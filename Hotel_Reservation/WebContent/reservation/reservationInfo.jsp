...
<%
	...
	PayBean pbt = new PayBean();
	pbt = pdb.resInfo(rsno);
	...
	if(rb!=null && pb!=null){
		...
		refund_price=pbt.getRefund_price();
		bank_name=pb.getBank_name();
		bank_num=pb.getBank_num();
		cancle_date=pbt.getCancle_date();
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			%>
				...
				<td>
					<% if(bank_name.equals("null")){
						...
						out.print(bank_name+"</td>");
					} %>
				</td>
				<th>계좌번호</th>
				<td colspan="2">
					<% if(bank_num.equals("null")){
						out.print(" "+"</td>");
					}else{
						out.print(bank_num+"</td>");
					} %>
				</td>
			<% 		
				}else{
			...
			<tr>
				...
				<% 
						if(icheck_in>itoday||refund_price==0){
				%>
