...
<body>
<div><jsp:include page="../reservation/res_register.jsp"/></div>
          ...
          <div class="tab-pane fade in show active">
            ...
            <div class="modal-body mb-1">
              <div class="options text-center text-md mt-1">
                ...
                data-toggle="modal" data-target="#modalRForm" data-dismiss="modal">Sign Up</a></p>
                <p>Reservation? <a href="../reservation/reservation.jsp" class="btn btn-secondary waves-effect ml-auto">비회원 예약</a></p>
              </div>
...
<div class="accordion res_info" id="accordionExample">
  <div class="card" >
